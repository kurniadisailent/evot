    ...
    <div class="col-md-12">
      <div class="card border rounded shadow-sm">
        ...
        <div class="card-body">
              ...
              <form form action="{{ route('calon.update',['calon'=>$data->id_calon]) }}" method="POST" enctype="multipart/form-data">
              @csrf
              @method('PUT')
                <!-- Foto -->
              ...
              <div class="form-group row">
                ...
                <div class="col-md-4">
                  <input value="{{ old('nama_ketua',$data->nama_ketua) }}" type="text" name="nama_ketua" class="form-control form-control-md border " id="colFormLabelSm" placeholder="Masukan nama" required>
                </div>
                <label for="nama_wakil" class="col-md-2 col-form-label col-form-label-md">Nama wakil</label>
                <div class="col-md-4">
                  <input value="{{ old('nama_wakil',$data->nama_wakil) }}" type="text" name="nama_wakil" class="form-control form-control-md border " id="colFormLabelSm" placeholder="Masukan nama" required>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-4">
                  <input value="{{ old('kelas_ketua',$data->kelas_ketua) }}" type="text" name="kelas_ketua" class="form-control form-control-md border " id="colFormLabelSm" value="" placeholder="Masukan Kelas" required>
                </div>
                <label for="kelas_wakil" class="col-md-2 col-form-label col-form-label-md">Kelas wakil</label>
                <div class="col-md-4">
                  <input value="{{ old('kelas_wakil',$data->kelas_wakil) }}" type="text" name="kelas_wakil" class="form-control form-control-md border " id="colFormLabelSm" value="" placeholder="Masukan Kelas" required>
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-10">
                  <textarea type="text" name="visi" class="form-control form-control-md border " id="colFormLabelSm" rows="3" required>{{ old('visi',$data->visi) }}</textarea> 
                </div>
              </div>
              ...
              <div class="form-group row">
                ...
                <div class="col-md-10">
                  <textarea type="text" name="misi" class="form-control form-control-md border " id="colFormLabelSm" rows="3" required>{{ old('misi',$data->misi) }}</textarea> 
                </div>
              </div>
